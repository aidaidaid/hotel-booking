import type { Country, Hotel, BoardType, MealPlan } from './types'
...
export const boardTypes: BoardType[] = [
  { code: 'FB', name: 'Full Board', description: 'Breakfast, lunch & dinner (optional)' },
  { code: 'HB', name: 'Half Board', description: 'Breakfast and one meal (optional)' },
  { code: 'NB', name: 'No Board', description: 'No meals included' },
]

export const mealsByCountry: Record<string, MealPlan> = {
  Turkey: {
    dinner: [
